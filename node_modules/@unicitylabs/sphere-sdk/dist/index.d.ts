...
interface OracleProvider extends BaseProvider {
     ...
     */
    validateToken(tokenData: unknown): Promise<ValidationResult$1>;
...
type OracleEventType = 'oracle:connected' | 'oracle:disconnected' | 'oracle:error' | 'validation:completed';
...
type AggregatorProvider = OracleProvider;
/** @deprecated Use OracleEventType instead */
type AggregatorEventType = OracleEventType;
/** @deprecated Use OracleEvent instead */
type AggregatorEvent = OracleEvent;
/** @deprecated Use OracleEventCallback instead */
type AggregatorEventCallback = OracleEventCallback;
...
interface WholeBlobStore<TData extends TxfStorageDataBase = TxfStorageDataBase> {
    load(identifier?: string): Promise<LoadResult<TData>>;
    save(data: TData): Promise<SaveResult>;
}
/**
 ...
 */
declare class WholeBlobInventoryAdapter<TData extends TxfStorageDataBase = TxfStorageDataBase> {
    private readonly store;
    constructor(store: WholeBlobStore<TData>);
    private loadData;
    /** View computed from the loaded set: all `'active'`, synthetic seq/cursor, `more: false`. */
    listInventory(_since?: bigint): Promise<InventoryView>;
     ...
     */
    applyDelta(_transferId: string, spent: string[], added: ApplyDeltaAdded[], _opts?: ApplyDeltaOptions): Promise<void>;
}
 ...
 */
declare function tokenIdFromKey(key: string): string;
/**
...
declare function createPaymentsModule(config?: PaymentsModuleConfig): PaymentsModule;
...
interface TransportProviderConfig {
    type: 'nostr';
    relays?: string[];
    timeout?: number;
 ...
 */
interface AggregatorProviderConfig {
...
declare const STORAGE_KEYS_ADDRESS: {
     ...
     */
    readonly PENDING_V2_DELIVERIES: "pending_v2_deliveries";
 ...
 */
declare const DEFAULT_AGGREGATOR_URL: "https://aggregator.unicity.network/rpc";
/** Dev aggregator URL */
declare const DEV_AGGREGATOR_URL: "https://dev-aggregator.dyndns.org/rpc";
/** Test aggregator URL (Goggregator) */
declare const TEST_AGGREGATOR_URL: "https://goggregator-test.unicity.network";
...
declare const TIMEOUTS: {
    ...
    readonly WEBSOCKET_CONNECT: 10000;
    /** Nostr relay reconnect delay */
    readonly NOSTR_RECONNECT_DELAY: 3000;
    /** Max reconnect attempts */
    readonly MAX_RECONNECT_ATTEMPTS: 5;
    /** Proof polling interval */
    readonly PROOF_POLL_INTERVAL: 1000;
    /** Sync interval */
    readonly SYNC_INTERVAL: 60000;
};
declare const LIMITS: {
    /** Min nametag length */
    readonly NAMETAG_MIN_LENGTH: 3;
    /** Max nametag length */
    readonly NAMETAG_MAX_LENGTH: 20;
    /** Max memo length */
 ...
 */
declare function createSwapModule(config?: SwapModuleConfig): SwapModule;
 ...
 */
declare function computeSwapId(fields: ManifestFields): string;
/**
 ...
 */
declare function buildManifest(resolvedPartyA: string, resolvedPartyB: string, deal: SwapDeal, timeout: number, escrowAddress?: string): SwapManifest;
/**
 ...
 */
declare function validateManifest(manifest: SwapManifest): {
    valid: boolean;
    errors: string[];
};
/**
 ...
 */
declare function verifyManifestIntegrity(manifest: SwapManifest): boolean;
/**
 ...
 */
declare function signSwapManifest(privateKey: string, swapId: string, escrowAddress: string): string;
/**
 ...
 */
declare function verifySwapSignature(swapId: string, escrowAddress: string, signature: string, chainPubkey: string): boolean;
declare function createNametagBinding(privateKey: string, nametag: string, directAddress: string, swapId: string, chainPubkey: string): NametagBindingProof;
/**
 ...
 */
declare function verifyNametagBinding(proof: NametagBindingProof, swapId: string): boolean;
 ...
 */
interface LegacyFileParseResult {
    success: boolean;
 ...
 */
declare function decryptTextFormatKey(encryptedKey: string, password: string): string | null;
/**
 * Check if content is wallet text format
 */
declare function isWalletTextFormat(content: string): boolean;
/**
 * Check if text wallet is encrypted
 */
declare function isTextWalletEncrypted(content: string): boolean;
/**
 * Parse wallet from text format (unencrypted)
 */
declare function parseWalletText(content: string): LegacyFileParseResult;
/**
...
type ValidationAction = 'ACCEPT' | 'RETRY_LATER' | 'DISCARD_FORK';
interface ExtendedValidationResult extends TokenValidationResult {
...
declare class TokenValidator {
    ...
    private spentStateCache;
    private readonly UNSPENT_CACHE_TTL_MS;
    constructor(engine: ITokenEngine);
    /** Validate all tokens (parallel, with a batch limit). */
    validateAllTokens(tokens: SphereToken[], options?: {
        batchSize?: number;
    ...
    checkSpentTokens(tokens: SphereToken[], options?: {
        batchSize?: number;
        onProgress?: (completed: number, total: number) => void;
...
declare function createTokenValidator(engine: ITokenEngine): TokenValidator;
 ...
 */
declare function isValidDirectAddress(address: string): boolean;
/**
