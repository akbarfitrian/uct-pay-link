...
declare class FileTokenStorageProvider implements TokenStorageProvider<TxfStorageDataBase> {
    ...
    private readonly inventoryAdapter;
 ...
 */
declare function createNodeTrustBaseLoader(filePathOrNetwork?: string | NetworkType, fallbackNetwork?: NetworkType): TrustBaseLoader$1;
/**
...
export { type BaseOracleConfig, type BaseProviders, type BaseTransportConfig, FileStorageProvider, type FileStorageProviderConfig, type FileTokenStorageConfig, FileTokenStorageProvider, type IWebSocket, type NodeIpfsSyncConfig, type NodeOracleConfig, type NodeProviders, type NodeProvidersConfig, type NodeTokenSyncConfig, type NodeTransportConfig, NodeTrustBaseLoader, NostrTransportProvider, type NostrTransportProviderConfig, type SphereBaseProviders, type SphereProviderPorts, type TrustBaseLoader$1 as TrustBaseLoader, UnicityAggregatorProvider, type UnicityAggregatorProviderConfig, UnicityOracleProvider, type UnicityOracleProviderConfig, type WalletApiCompositionConfig, WalletApiMailboxProvider, type WalletApiMailboxProviderConfig, type WalletApiProviderExtras, type WalletApiTokenStorageConfig, WalletApiTokenStorageProvider, type WebSocketFactory, createFileStorageProvider, createFileTokenStorageProvider, createNodeProviders, createNodeTrustBaseLoader, createNodeWebSocketFactory, createNostrTransportProvider, createOwnStorageWalletApiProviders, createSphereProviders, createUnicityAggregatorProvider, createUnicityOracleProvider, createWalletApiMailboxProvider, createWalletApiProviders, createWalletApiTokenStorageProvider };
