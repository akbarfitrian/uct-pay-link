 ...
 */
export async function createBindingEvent(keyManager, nametagId, unicityAddress, defaultCountry = DEFAULT_COUNTRY, identity) {
    ...
    if (identity) {
        const encryptedNametag = await NametagUtils.encryptNametag(nametagId, keyManager.getPrivateKeyHex());
 ...
 * @returns Signed event
 */
export function createIdentityBindingEvent(keyManager, identity) {
 ...
 * @returns Filter for nametag binding events
 */
export function createAddressToBindingFilter(address) {
 ...
 */
export function parseBindingInfo(event) {
    try {
